# Author: Rewritten by ChatGPT for clarity and modularity
# Original: imshawan <hello@imshawan.dev>
# Date: 08-04-2025
...
def parse_job_page(relative_url: str) -> dict:
    ...
    # Example selectors — you'll need to adjust these by inspecting the page:
